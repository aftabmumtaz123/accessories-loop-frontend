                ...
                <div className="p-1">
                  ...
                  <div className="relative p-3 border-t">
                    ...
                    <div className="mt-1.5 flex items-center justify-between text-text">
                      ...
                      <button onClick={() => {addProduct(product._id); toast.success('Item Added to Cart!!')}} type="button" class="inline-flex items-center gap-1.5 rounded-lg border border-primary bg-white px-4 py-2.5 text-center text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-100 focus:ring focus:ring-gray-100  hover:border-secondary">
                        Add
